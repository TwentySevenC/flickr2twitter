...
public final class MyPersistenceManagerFactory {
	...
	private static final Logger log = Logger.getLogger(MyPersistenceManagerFactory.class.getName());
	...
	public static GlobalSourceApplicationService getGlobalSourceAppService(String providerId) {
	...
	public static GlobalTargetApplicationService getGlobalTargetAppService(String providerId) {
		PersistenceManagerFactory pmf = MyPersistenceManagerFactory.getInstance();
		PersistenceManager pm = pmf.getPersistenceManager();
		try {
	...
	public static User createNewUser(String userEmail, String password, String screenName) {
		return createNewUser(userEmail, password, screenName, Permission.NORMAL);
	}
	
	public static UserSourceService addSourceServiceApp(String userEmail, UserSourceService srcService) {
		return addSourceServiceApp(getUser(userEmail), srcService);
	}
	
	public static UserSourceService addSourceServiceApp(User user, UserSourceService srcService) {
		if (user == null) {
	...
	public static UserTargetService addTargetServiceApp(String userEmail, UserTargetService targetService) {
		return addTargetServiceApp(getUser(userEmail), targetService);
	}
	
	public static UserTargetService addTargetServiceApp(User user, UserTargetService targetService) {
		if (user == null) {
			throw new IllegalArgumentException("Invalid user: " + user);
		}
	...
	public static User createNewUser(String userEmail, String password, String screenName, Permission permission) {
